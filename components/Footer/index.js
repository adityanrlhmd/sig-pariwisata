  ...
  return (
    <footer className="footer footer-center p-10 bg-slate-800 text-primary-content">
      <div>
        ...
        <p>
          Copyright © 2023 - <Link href="https://www.instagram.com/rezamultiaha_/">Muh Reza Multiaha</Link>
        </p>
      </div>
      <div>
        <div className="grid grid-flow-col gap-4">
          <Link href="https://www.instagram.com/rezamultiaha_/" className="social-media">
